...
#include <afxext.h>
#include "..\ZFNest\ZFNestDoc.h"
#include "..\ZFNest\ZFNestView.h"
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		CCreateContext ctx;
		ctx.m_pNewViewClass = RUNTIME_CLASS(CZFNestView);
		...
		m_pDocument->AddRef();
		ctx.m_pCurrentDoc = DYNAMIC_DOWNCAST(CZFNestDoc, (CObject*) m_pDocument->GetContainer());
